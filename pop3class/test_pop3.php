...
<?php
  ...
  /* Uncomment when using SASL authentication mechanisms */
	...
	*/
	...
	$pop3=new pop3_class;
	$pop3->hostname="pop.googlemail.com";             /* POP 3 server host name                      */
	...
	$user="ilmastino.php@gmail.com";                        /* Authentication user name                    */
	$password="ramd6v53";                    /* Authentication password                     */
