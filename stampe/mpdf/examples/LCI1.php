...
while ($istudenti<$nestudenti) {
  ...
  for ($i=1;$i<=$nrowpag;$i++) {
    for ($j=1;$j<=2;$j++) {
      ...
      if ($j==1) {
        ...
        $istudenti++;
        $tab2 .= "<TD ROWSPAN=2 STYLE='height:15pt;border:1px solid #000000;width:70pt;'>".$studenti[$istudenti]."</TD>";      
      }
    ...
    $tab2.="<TR><TD COLSPAN=32 STYLE='height:12pt;'> </TD></TR>";
  }
  $tab2.="</TABLE>";
  ...
  $tab2.="<TR><TD STYLE='height:25pt;'></TD><TD STYLE='height:25pt;'></TD><TD STYLE='height:25pt;'></TD><TD STYLE='height:25pt;'></TD><TD STYLE='height:25pt;'></TD><TD STYLE='height:25pt;'></TD></TR></TABLE>";
  $mpdf->WriteHTML($tab2);
  $tab2="";
  $mpdf->AddPage('L','','','','',5,5,5,15,18,12);
  $volte++;
